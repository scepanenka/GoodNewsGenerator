...
namespace GoodNews.BL.Views
{
    public class SourcesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Description,Id")] Source source)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Name,Description,Id")] Source source)
        {
            if (id != source.Id)
            {
                return NotFound();
